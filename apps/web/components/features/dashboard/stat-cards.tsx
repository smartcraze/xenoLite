  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
      {stats.map((stat, index) => {
        ...
        return (
          <Card key={index} className="border-border/50 bg-card overflow-hidden relative group">
            <CardContent className="p-6 relative z-10">
              ...
              <p className={`text-xs mt-4 font-medium ${isPositive ? 'text-green-500' : 'text-red-500'}`}>
                {stat.change}
              </p>
            </CardContent>
